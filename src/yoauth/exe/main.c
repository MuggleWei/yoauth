...
{
	YOAUTH_OUTPUT("normal output");
	YOAUTH_ERROR("error output");
	YOAUTH_TIP("tip output");
	YOAUTH_OUTPUT_TITLE("Title");
	YOAUTH_OUTPUT_COMMAND_DESC("-k, --key", "value");
	YOAUTH_OUTPUT("bye bye");
